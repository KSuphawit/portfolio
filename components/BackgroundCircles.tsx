...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      {/* <div className="rounded-full border border-[#333333] h-[100px] w-[100px] md:h-[200px] md:w-[200px] absolute mt-52 animate-ping" />
      <div className="rounded-full border border-[#333333] h-[200px] w-[200px] md:h-[300px] md:w-[300px] absolute mt-52" />
      <div className="rounded-full border border-[#333333] h-[400px] w-[400px] md:h-[500px] md:w-[500px] absolute mt-52" />
      <div className="rounded-full border border-[#F7AB0A] opacity-20 h-[550px] w-[550px] md:h-[650px] md:w-[650px] absolute mt-52 animate-pulse" />
      <div className="rounded-full border border-[#333333] h-[700px] w-[700px] md:h-[800px] md:w-[800px] absolute mt-52" /> */}
